        ...
        stackGraphs: function(a) {
            ...
            for (p = n; p <= l; p++) {
                ...
                for (q = 0; q < k.length; q++)
                    if (n = k[q], n.hidden) n.newStack && (h[p] = NaN,
                        e[p] = NaN);
            ...
            for (p = this.start; p <= this.end; p++)
                for (q = 0; q < k.length; q++)(n = k[q], n.hidden) ? n.newStack && (h[p] = NaN, e[p] = NaN) : (m = n.type, n.chart == this.chart && n.valueAxis ==
