    ...
    e.Cuboid = e.Class({
        ...
        draw: function() {
            ...
            if (0 < Math.abs(h) || 0 < Math.abs(k))
                if (isNaN(y)) q = C, C = e.adjustLuminosity(G, -.2), C = e.adjustLuminosity(G, -.2), v = e.polygon(b, [0, h, d + h, d, 0], [0, k, k, 0, 0],
                    ...
                    J = r * y;
                    L = x * y;.1 < r && .1 < r && (v = e.circle(b, r, G, l, t, u, g, !1, x), v.translate(C, O));.1 < J && .1 < J && (q = e.circle(b, J, e.adjustLuminosity(G, .5), l, t, u, g, !1, L), q.translate(P, Q))
                }
            l = K;
            1 > Math.abs(f) && (f = 0);
            1 > Math.abs(d) && (d = 0);
            ...
            d = isNaN(y) ? 0 > f ? [v,
                B, H, M, m, w, A, q, p, b
            ] : [q, p, H, M, m, w, v, B, A, b] : N ? 0 < d ? [v, b, q] : [q, b, v] : 0 > f ? [v, b, q] : [q, b, v];
            e.setCN(c, b, z + "front");
            e.setCN(c, H, z + "back");
            e.setCN(c, q, z + "top");
